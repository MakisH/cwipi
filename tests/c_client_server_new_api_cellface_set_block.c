...
)
{
  ...
  if (rank == 0) {
    ...
    system("mpirun $Oversubscribe -n 1 cwp_server -cn code0 -p 49104 49104 -c \"client_new_api_cellface_set_block_o/code1/cwp_config_srv.txt\" : -n 1 cwp_server -cn code1 -p 49105 49105 -c \"client_new_api_cellface_set_block_o/code2/cwp_config_srv.txt\" &");
  }
