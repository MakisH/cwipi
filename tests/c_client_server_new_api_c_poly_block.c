...
)
{
  ...
  if (rank == 0) {
    ...
    system("mpirun $Oversubscribe -n 1 cwp_server -cn code1 -p 48102 48102 -c \"client_new_api_c_poly_block_o/code1/cwp_config_srv.txt\" : -n 1 cwp_server -cn code2 -p 48103 48103 -c \"client_new_api_c_poly_block_o/code2/cwp_config_srv.txt\" &");
  }
